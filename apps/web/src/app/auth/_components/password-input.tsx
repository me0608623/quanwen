      ...
      <div>
        <div className="relative">
          ...
          <Input
            ...
            value={value}
            className={cn(
              "h-11 rounded-[10px] border-slate-200 pl-11 pr-11 text-[16px] focus-visible:border-[#1F6FEB] focus-visible:ring-2 focus-visible:ring-[#1F6FEB]/15",
              className
            )}
            {...props}
          />
          <button
            ...
            className="absolute right-0.5 top-1/2 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-md text-slate-400 hover:bg-slate-50 hover:text-slate-700"
          >
