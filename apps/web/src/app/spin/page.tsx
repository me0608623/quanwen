            ...
            {status?.canSpin ? (
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-center gap-4 text-sm">
                  <Link href="/tasks" className="inline-flex min-h-[44px] items-center rounded-md px-3 py-2 font-semibold text-amber-600 hover:bg-amber-50">
                    去填問卷賺次數 →
                  </Link>
                  <Link href="/mutual" className="inline-flex min-h-[44px] items-center rounded-md px-3 py-2 font-semibold text-amber-600 hover:bg-amber-50">
                    互惠問卷 →
                  </Link>
                </div>
              </div>
