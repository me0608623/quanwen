 ...
 * 圖片：7-11 100/200/500 已放 apps/web/public/vouchers/（不可放 /shop/，會被 middleware 當作受保護路由攔截）；其餘（7-11 50/300、全家全系列）
...
export const VOUCHER_CATALOG: NewPointShopItem[] = [
  ...
  { name: '7-ELEVEN 100 元數位商品禮券', description: '全台 7-ELEVEN 門市通用，無使用期限。', category: 'voucher_711', faceValue: 100, costPoints: 200, imageUrl: '/vouchers/voucher-711-100.jpg', stockQty: -1, sortOrder: 11 },
  { name: '7-ELEVEN 200 元數位商品禮券', description: '全台 7-ELEVEN 門市通用，無使用期限。', category: 'voucher_711', faceValue: 200, costPoints: 400, imageUrl: '/vouchers/voucher-711-200.jpg', stockQty: -1, sortOrder: 12 },
  ...
  { name: '7-ELEVEN 500 元數位商品禮券', description: '全台 7-ELEVEN 門市通用，無使用期限。', category: 'voucher_711', faceValue: 500, costPoints: 1000, imageUrl: '/vouchers/voucher-711-500.jpg', stockQty: -1, sortOrder: 14 },
  // ── 全家 FamilyMart ──
